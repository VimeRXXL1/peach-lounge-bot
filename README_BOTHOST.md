...
## Если эмодзи в профиле отображались квадратиками
В версии v4.3 добавлен рендер эмодзи через Twemoji PNG. Бот сам кеширует картинки в `data/emoji_cache`. После обновления перезапусти бота; при первом `/profile` ему нужен интернет, чтобы скачать эмодзи.
